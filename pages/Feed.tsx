                    ...
                    <AvatarFallback
                      className={
                        post.isAnnouncement
                          ...
                          : "bg-muted text-muted-foreground font-heading"
                      }
                    >
                      {post.user.avatar}
                    </AvatarFallback>
                  ...
                  {post.isAnnouncement ? (
                    ...
                    <div className="bg-primary/10 border border-primary/20 rounded-xl p-4">
                      <div className="flex items-center gap-3 mb-4">
                        ...
                        <h3 className="text-2xl font-heading tracking-wide text-primary">
                        ...
                        {post.pbs?.map((pb: any, i: number) => (
                          ...
                          >
                            <span className="font-bold text-lg">
                              {getExerciseName(pb.exercise)}
                            </span>
                            <span className="text-xl font-heading tracking-wider text-primary">
                      ...
                      <div className="flex items-center justify-between mb-4">
                        ...
                        {post.reward && (
                          <div className="flex items-center gap-2 bg-primary/10 text-primary px-3 py-1 rounded-full text-sm font-bold">
                            ...
                            <span>
                              {post.reward.count && post.reward.count > 1
                                ? `${post.reward.count.toLocaleString()} `
                                : ""}
                              {post.reward.displayName || post.reward.name} (
                              {post.volume?.toLocaleString()}kg)
                            </span>
                          </div>
                        )}
                      </div>
