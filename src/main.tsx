...
const MACHINE_REDIRECTS: Record<string, string> = {
  ...
  "adductor-abductor":
    "https://etlfittrack.netlify.app/machine/adductor-abductor",
  ...
  "seated-cable-row":
    "https://etlfittrack.netlify.app/machine/seated-cable-row",
  ...
  "shoulder-press-machine":
    "https://etlfittrack.netlify.app/machine/shoulder-press-machine",
  "incline-plate-chest-press":
    "https://etlfittrack.netlify.app/machine/incline-plate-chest-press",
  "seated-chest-press":
    "https://etlfittrack.netlify.app/machine/seated-chest-press",
  ...
  "functional-trainer":
    "https://etlfittrack.netlify.app/machine/functional-trainer",
