...
export function AppLayout({ children }: { children: React.ReactNode }) {
  ...
  const [syncStatus, setSyncStatusLocal] =
      ...
      <div className="flex h-screen w-full bg-background font-sans flex-col items-center justify-center px-6 text-center">
        <div className="max-w-sm space-y-6">
          ...
          <p className="text-muted-foreground text-sm leading-relaxed">
            We can't see an active membership for your account. If you've just
            renewed, give it a few minutes. Otherwise, get in touch and we'll
            sort it.
          </p>
          <div className="flex flex-col gap-2">
            <a href="mailto:michael@eattrainlivesmart.co.uk">
              <Button className="w-full gap-2">Contact Us</Button>
            </a>
            <Button
              variant="outline"
              className="w-full"
    ...
    <div className="flex h-screen w-full bg-background font-sans flex-col overflow-hidden">
      <header className="h-16 border-b border-border flex items-center justify-between px-4 bg-background sticky top-0 z-30 shrink-0 select-none">
        <div className="flex items-center gap-2">
          ...
          <span className="font-heading text-xl text-foreground uppercase tracking-wider mt-1">
            FitTrack
          </span>
        </div>
        <div className="flex items-center gap-2">
