...
const Index = () => {
  ...
  if (sortedHistory.length > 0) {
    ...
    const diffDays = Math.floor(
      (currentDate.getTime() - lastWorkoutDate.getTime()) /
        (1000 * 60 * 60 * 24),
    );
  ...
  const currentWeight =
    bwData.length > 0 ? bwData[bwData.length - 1].weight : 0;
  ...
  return (
    <div className="flex-1 space-y-6 p-4 md:p-8 pt-6 pb-24">
      <div className="flex flex-col mb-6">
        ...
        <h2 className="text-3xl font-heading tracking-wider uppercase leading-none">
          {userName || "there"}
        </h2>
      ...
      <div className="space-y-3">
        ...
        allowedAccess.includes(bucketOf(activeProgram)) ? (
          (() => {
            ...
            const dated =
              activeProgram.workouts?.filter((c: any) => c.date) || [];
              ...
              >
                ...
                <div className="min-w-0 flex-1">
                  ...
                  <p className="text-xs text-muted-foreground truncate">
                    {isRestDay
                      ? "Rest Day"
                      : `${targetWorkout?.name} · Workout ${targetIndex + 1} of ${activeProgram.workouts.length}`}
                  </p>
                </div>
          ...
          >
            ...
            <div className="min-w-0 flex-1">
              ...
              <p className="font-heading text-xl tracking-wider uppercase leading-none text-muted-foreground">
                Browse Library
              </p>
              <p className="text-xs text-muted-foreground truncate">
      ...
      <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-7">
        <Card className="col-span-4 bg-card border-border">
          <CardHeader>
            ...
            <CardDescription>
              Your workout duration over the past 7 days
            </CardDescription>
          </CardHeader>
        ...
        <Card className="col-span-3 bg-card border-border flex flex-col">
          ...
          <CardContent className="flex-1">
            ...
            <h3 className="font-heading text-xl tracking-wider mb-4">
              Recent Workouts
            </h3>
